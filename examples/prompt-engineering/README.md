...
|---------|-------|-------------|
| [example-prompt-loader.py](example-prompt-loader.py) | Versioned prompt repository | [Prompt Versioning](../../domains/prompt-engineering/prompt-versioning.md) |
| [example-prompt-chaining.py](example-prompt-chaining.py) | Multi-step prompt pipeline | [Prompt Chaining](../../domains/prompt-engineering/prompt-chaining.md) |
| [example-few-shot-classification.py](example-few-shot-classification.py) | Few-shot message building | [Prompting Strategies](../../domains/prompt-engineering/prompting-strategies.md) |
