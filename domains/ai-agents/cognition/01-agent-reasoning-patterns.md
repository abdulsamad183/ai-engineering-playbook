...
> ReAct, reflection, planning, ToT, debate, self-consistency — architecture, workflows, production tradeoffs.
...
Part of **Cognition** in the **AI Agents** handbook. Treat **Agent Reasoning Patterns** as an implementable engineering topic.
...
**Agent Reasoning Patterns** — ReAct, reflection, planning, ToT, debate, self-consistency — architecture, workflows, production tradeoffs.
...
**Scenario:** Apply **Agent Reasoning Patterns** to a production-shaped slice of traffic.
...
**Q: How do you explain agent reasoning patterns in a system design interview?**
