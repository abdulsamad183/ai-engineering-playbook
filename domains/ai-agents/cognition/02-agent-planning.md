...
> Planning algorithms, decomposition, sequential/parallel/dynamic planning, replanning, hierarchical planning, execution graphs.
...
Part of **Cognition** in the **AI Agents** handbook. Treat **Agent Planning** as an implementable engineering topic.
...
**Agent Planning** — Planning algorithms, decomposition, sequential/parallel/dynamic planning, replanning, hierarchical planning, execution graphs.
...
**Scenario:** Apply **Agent Planning** to a production-shaped slice of traffic.
...
**Q: How do you explain agent planning in a system design interview?**
