...
# Semantic Kernel for Agents

> Semantic Kernel — plugins, planners, enterprise .NET/Python agent patterns.
...
Part of **Frameworks** in the **AI Agents** handbook. Treat **Semantic Kernel for Agents** as an implementable engineering topic.
...
**Semantic Kernel for Agents** — Semantic Kernel — plugins, planners, enterprise .NET/Python agent patterns.
...
**Scenario:** Apply **Semantic Kernel for Agents** to a production-shaped slice of traffic.
...
**Q: How do you explain semantic kernel for agents in a system design interview?**
