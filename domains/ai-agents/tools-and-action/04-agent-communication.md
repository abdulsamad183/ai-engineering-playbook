...
> Message passing, shared memory, negotiation, coordination, synchronization, conflict resolution.
...
Part of **Tools And Action** in the **AI Agents** handbook. Treat **Agent Communication** as an implementable engineering topic.
...
**Agent Communication** — Message passing, shared memory, negotiation, coordination, synchronization, conflict resolution.
...
**Scenario:** Apply **Agent Communication** to a production-shaped slice of traffic.
...
**Q: How do you explain agent communication in a system design interview?**
