...
> Event bus, triggers, pub/sub, async execution, reactive agent architectures.
...
Part of **Tools And Action** in the **AI Agents** handbook. Treat **Event-Driven Agents** as an implementable engineering topic.
...
**Event-Driven Agents** — Event bus, triggers, pub/sub, async execution, reactive agent architectures.
...
**Scenario:** Apply **Event-Driven Agents** to a production-shaped slice of traffic.
...
**Q: How do you explain event-driven agents in a system design interview?**
