...
> Evaluating agents — task success, tool accuracy, planning quality, latency, cost, reliability, failure recovery.
...
Part of **Eval Security Production** in the **AI Agents** handbook. Treat **Agent Evaluation** as an implementable engineering topic.
...
**Agent Evaluation** — Evaluating agents — task success, tool accuracy, planning quality, latency, cost, reliability, failure recovery.
...
**Scenario:** Apply **Agent Evaluation** to a production-shaped slice of traffic.
...
**Q: How do you explain agent evaluation in a system design interview?**
