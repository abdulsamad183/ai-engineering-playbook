...
> Agent vs workflow, ReAct vs reflection, supervisor vs swarm, framework comparison, memory and planning strategies.
...
Part of **Eval Security Production** in the **AI Agents** handbook. Treat **Agent Comparison Guides** as an implementable engineering topic.
...
**Agent Comparison Guides** — Agent vs workflow, ReAct vs reflection, supervisor vs swarm, framework comparison, memory and planning strategies.
...
**Scenario:** Apply **Agent Comparison Guides** to a production-shaped slice of traffic.
...
**Q: How do you explain agent comparison guides in a system design interview?**
