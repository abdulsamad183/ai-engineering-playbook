...
> Agent security — tool permissions, injection, sandboxing, secrets, approval gates, resource limits.
...
Part of **Eval Security Production** in the **AI Agents** handbook. Treat **Agent Security** as an implementable engineering topic.
...
**Agent Security** — Agent security — tool permissions, injection, sandboxing, secrets, approval gates, resource limits.
...
**Scenario:** Apply **Agent Security** to a production-shaped slice of traffic.
...
**Q: How do you explain agent security in a system design interview?**
