...
> Code assistant architecture — AST, code graph, refactoring, PR generation, code review.
...
Part of **Developer Tools** in the **AI System Design** handbook. Treat **Design: AI Coding Assistant** as an implementable engineering topic.
...
**Design: AI Coding Assistant** — Code assistant architecture — AST, code graph, refactoring, PR generation, code review.
...
**Scenario:** Apply **Design: AI Coding Assistant** to a production-shaped slice of traffic.
...
**Q: How do you explain design: ai coding assistant in a system design interview?**
