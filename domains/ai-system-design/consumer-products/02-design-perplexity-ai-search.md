...
> AI search — web retrieval, citations, multi-query, answer synthesis, freshness.
...
Part of **Consumer Products** in the **AI System Design** handbook. Treat **Design: Perplexity-style AI Search** as an implementable engineering topic.
...
**Design: Perplexity-style AI Search** — AI search — web retrieval, citations, multi-query, answer synthesis, freshness.
...
**Scenario:** Apply **Design: Perplexity-style AI Search** to a production-shaped slice of traffic.
...
**Q: How do you explain design: perplexity-style ai search in a system design interview?**
