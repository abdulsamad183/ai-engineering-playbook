...
> Multi-agent research — planning, crawling, citations, long-running tasks, reports.
...
Part of **Consumer Products** in the **AI System Design** handbook. Treat **Design: Deep Research System** as an implementable engineering topic.
...
**Design: Deep Research System** — Multi-agent research — planning, crawling, citations, long-running tasks, reports.
...
**Scenario:** Apply **Design: Deep Research System** to a production-shaped slice of traffic.
...
**Q: How do you explain design: deep research system in a system design interview?**
