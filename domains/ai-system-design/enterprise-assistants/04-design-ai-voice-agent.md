...
> Voice AI — STT, VAD, streaming, TTS, interruptions, real-time tools.
...
Part of **Enterprise Assistants** in the **AI System Design** handbook. Treat **Design: AI Voice Agent** as an implementable engineering topic.
...
**Design: AI Voice Agent** — Voice AI — STT, VAD, streaming, TTS, interruptions, real-time tools.
...
**Scenario:** Apply **Design: AI Voice Agent** to a production-shaped slice of traffic.
...
**Q: How do you explain design: ai voice agent in a system design interview?**
