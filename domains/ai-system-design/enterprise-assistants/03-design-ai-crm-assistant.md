...
> CRM AI — customer profiles, memory, opportunities, workflow automation.
...
Part of **Enterprise Assistants** in the **AI System Design** handbook. Treat **Design: AI CRM Assistant** as an implementable engineering topic.
...
**Design: AI CRM Assistant** — CRM AI — customer profiles, memory, opportunities, workflow automation.
...
**Scenario:** Apply **Design: AI CRM Assistant** to a production-shaped slice of traffic.
...
**Q: How do you explain design: ai crm assistant in a system design interview?**
