...
This lesson is part of the **Model Evaluation Debugging** track in the **Deep Learning** handbook. Treat **Overfitting & Underfitting** as something you can implement, measure, and ship — not only define.
...
**Overfitting & Underfitting** — Diagnose capacity vs data — train/val curves tell the story.
