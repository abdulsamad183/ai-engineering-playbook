...
> GraphRAG, RAPTOR, Self-RAG, CRAG, Agentic RAG, Corrective RAG, Modular RAG, multi-hop, knowledge graph RAG.
...
Part of **Foundations** in the **RAG** handbook. Treat **Advanced RAG Architectures** as an implementable engineering topic.
...
**Advanced RAG Architectures** — GraphRAG, RAPTOR, Self-RAG, CRAG, Agentic RAG, Corrective RAG, Modular RAG, multi-hop, knowledge graph RAG.
...
**Scenario:** Apply **Advanced RAG Architectures** to a production-shaped slice of traffic.
...
**Q: How do you explain advanced rag architectures in a system design interview?**
