...
> Query preprocessing, rewriting, expansion, decomposition, routing, HyDE, and intent detection for retrieval.
...
Part of **Retrieval** in the **RAG** handbook. Treat **Query Engineering for RAG** as an implementable engineering topic.
...
**Query Engineering for RAG** — Query preprocessing, rewriting, expansion, decomposition, routing, HyDE, and intent detection for retrieval.
...
**Scenario:** Apply **Query Engineering for RAG** to a production-shaped slice of traffic.
...
**Q: How do you explain query engineering for rag in a system design interview?**
