...
> BM25 lexical retrieval — TF-IDF intuition, keyword search, hybrid fusion, why BM25 still matters in production RAG.
...
Part of **Retrieval** in the **RAG** handbook. Treat **BM25 for RAG** as an implementable engineering topic.
...
**BM25 for RAG** — BM25 lexical retrieval — TF-IDF intuition, keyword search, hybrid fusion, why BM25 still matters in production RAG.
...
**Scenario:** Apply **BM25 for RAG** to a production-shaped slice of traffic.
...
**Q: How do you explain bm25 for rag in a system design interview?**
