---
title: "Outputs, Logits & Heads"
description: "LM head, classification head, span head — task adapters on top."
domain: transformers
tags: [architecture-components, transformers]
status: published
created: 2026-08-11
updated: 2026-08-12
version: "2.0"
...
# Outputs, Logits & Heads

> LM head, classification head, span head — task adapters on top.
...
This lesson is part of the **Architecture Components** track in the **Transformers** handbook. Treat **Outputs, Logits & Heads** as something you can implement, measure, and ship — not only define.

**Typical workflow:** positions → FFN → norms → residuals.
...
**Outputs, Logits & Heads** — LM head, classification head, span head — task adapters on top.
...
Without a crisp grip on outputs, logits & heads, teams either overcomplicate baselines or under-diagnose failures. This topic shows up in interviews, design reviews, and production incidents.
...
**Scenario:** You must apply **Outputs, Logits & Heads** on a real dataset with a deadline.
...
**Q: How do you know outputs, logits & heads is the right tool?**
