...
description: "Where to put LayerNorm — modern stacks prefer pre-norm."
domain: transformers
...
> Where to put LayerNorm — modern stacks prefer pre-norm.
...
This lesson is part of the **Architecture Components** track in the **Transformers** handbook. Treat **Pre-Norm vs Post-Norm** as something you can implement, measure, and ship — not only define.
...
**Pre-Norm vs Post-Norm** — Where to put LayerNorm — modern stacks prefer pre-norm.
...
Without a crisp grip on pre-norm vs post-norm, teams either overcomplicate baselines or under-diagnose failures. This topic shows up in interviews, design reviews, and production incidents.
...
**Scenario:** You must apply **Pre-Norm vs Post-Norm** on a real dataset with a deadline.
...
**Q: How do you know pre-norm vs post-norm is the right tool?**
