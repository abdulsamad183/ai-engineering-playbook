...
description: "Three families — bidirectional encoders, causal decoders, and seq2seq."
domain: transformers
tags: [transformer-basics, transformers]
status: published
created: 2026-08-11
updated: 2026-08-12
version: "2.0"
...
> Three families — bidirectional encoders, causal decoders, and seq2seq.
...
This lesson is part of the **Transformer Basics** track in the **Transformers** handbook. Treat **Encoder vs Decoder vs Encoder-Decoder** as something you can implement, measure, and ship — not only define.

**Typical workflow:** embed → attention blocks → head.
...
**Encoder vs Decoder vs Encoder-Decoder** — Three families — bidirectional encoders, causal decoders, and seq2seq.
...
Without a crisp grip on encoder vs decoder vs encoder-decoder, teams either overcomplicate baselines or under-diagnose failures. This topic shows up in interviews, design reviews, and production incidents.
...
**Scenario:** You must apply **Encoder vs Decoder vs Encoder-Decoder** on a real dataset with a deadline.
...
**Q: How do you know encoder vs decoder vs encoder-decoder is the right tool?**
