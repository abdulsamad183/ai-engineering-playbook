...
description: "Greedy, temperature, top-k, nucleus — control diversity vs precision."
domain: transformers
...
> Greedy, temperature, top-k, nucleus — control diversity vs precision.
...
This lesson is part of the **Inference And Efficiency** track in the **Transformers** handbook. Treat **Sampling Strategies** as something you can implement, measure, and ship — not only define.
...
**Sampling Strategies** — Greedy, temperature, top-k, nucleus — control diversity vs precision.
...
Without a crisp grip on sampling strategies, teams either overcomplicate baselines or under-diagnose failures. This topic shows up in interviews, design reviews, and production incidents.
...
**Scenario:** You must apply **Sampling Strategies** on a real dataset with a deadline.
...
**Q: How do you know sampling strategies is the right tool?**
