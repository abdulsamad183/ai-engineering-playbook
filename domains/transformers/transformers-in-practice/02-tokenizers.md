---
title: "Tokenizers"
description: "BPE, WordPiece, Unigram — vocab design and special tokens."
domain: transformers
...
> BPE, WordPiece, Unigram — vocab design and special tokens.
...
This lesson is part of the **Transformers In Practice** track in the **Transformers** handbook. Treat **Tokenizers** as something you can implement, measure, and ship — not only define.
...
**Tokenizers** — BPE, WordPiece, Unigram — vocab design and special tokens.
...
Without a crisp grip on tokenizers, teams either overcomplicate baselines or under-diagnose failures. This topic shows up in interviews, design reviews, and production incidents.
...
**Scenario:** You must apply **Tokenizers** on a real dataset with a deadline.
...
**Q: How do you know tokenizers is the right tool?**
