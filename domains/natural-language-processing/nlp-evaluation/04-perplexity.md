---
title: "Perplexity"
description: "LM uncertainty — lower perplexity means better next-token fit."
...
> LM uncertainty — lower perplexity means better next-token fit.
...
This lesson belongs to **Nlp Evaluation** in the **Natural Language Processing** handbook. Goal: understand **Perplexity** well enough to implement, measure, and explain it in a design review.
...
**Perplexity** — LM uncertainty — lower perplexity means better next-token fit.
