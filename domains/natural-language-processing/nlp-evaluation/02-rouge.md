---
title: "ROUGE"
description: "Recall-oriented n-gram/LCS overlap — summarization staple."
...
> Recall-oriented n-gram/LCS overlap — summarization staple.
...
This lesson belongs to **Nlp Evaluation** in the **Natural Language Processing** handbook. Goal: understand **ROUGE** well enough to implement, measure, and explain it in a design review.
...
**ROUGE** — Recall-oriented n-gram/LCS overlap — summarization staple.
