---
title: "METEOR"
description: "Alignment-based MT metric with stemming/synonymy soft matches."
...
> Alignment-based MT metric with stemming/synonymy soft matches.
...
This lesson belongs to **Nlp Evaluation** in the **Natural Language Processing** handbook. Goal: understand **METEOR** well enough to implement, measure, and explain it in a design review.
...
**METEOR** — Alignment-based MT metric with stemming/synonymy soft matches.
...
Skipping meteor creates fragile systems: wrong preprocessing, silent metric lies, or APIs used without understanding failure modes. This topic is foundational for later LLM/RAG/agent work.
...
**Scenario:** Apply **METEOR** on a small real dataset or API workload.
...
**Q: Explain meteor to a senior engineer in two minutes.**
