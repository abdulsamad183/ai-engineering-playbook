---
title: "N-Grams"
description: "Local token sequences — unigrams, bigrams, trigrams as features."
...
> Local token sequences — unigrams, bigrams, trigrams as features.
...
This lesson belongs to **Text Representation** in the **Natural Language Processing** handbook. Goal: understand **N-Grams** well enough to implement, measure, and explain it in a design review.
...
**N-Grams** — Local token sequences — unigrams, bigrams, trigrams as features.
...
Skipping n-grams creates fragile systems: wrong preprocessing, silent metric lies, or APIs used without understanding failure modes. This topic is foundational for later LLM/RAG/agent work.
...
**Scenario:** Apply **N-Grams** on a small real dataset or API workload.
...
**Q: Explain n-grams to a senior engineer in two minutes.**
