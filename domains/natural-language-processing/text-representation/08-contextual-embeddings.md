...
description: "Same word, different vector — ELMo/BERT/GPT hidden states."
domain: natural-language-processing
tags: [text-representation, natural-language-processing]
status: published
created: 2026-08-11
updated: 2026-08-12
version: "2.0"
...
> Same word, different vector — ELMo/BERT/GPT hidden states.
...
This lesson belongs to **Text Representation** in the **Natural Language Processing** handbook. Goal: understand **Contextual Embeddings** well enough to implement, measure, and explain it in a design review.
...
**Contextual Embeddings** — Same word, different vector — ELMo/BERT/GPT hidden states.
...
Skipping contextual embeddings creates fragile systems: wrong preprocessing, silent metric lies, or APIs used without understanding failure modes. This topic is foundational for later LLM/RAG/agent work.
...
**Scenario:** Apply **Contextual Embeddings** on a small real dataset or API workload.
...
**Q: Explain contextual embeddings to a senior engineer in two minutes.**
