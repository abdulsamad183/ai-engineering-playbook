...
description: "Answer questions from context — extractive spans or generative answers."
domain: natural-language-processing
tags: [nlp-tasks, natural-language-processing]
status: published
created: 2026-08-11
updated: 2026-08-12
version: "2.0"
...
> Answer questions from context — extractive spans or generative answers.
...
This lesson belongs to **Nlp Tasks** in the **Natural Language Processing** handbook. Goal: understand **Question Answering** well enough to implement, measure, and explain it in a design review.
...
**Question Answering** — Answer questions from context — extractive spans or generative answers.
...
Skipping question answering creates fragile systems: wrong preprocessing, silent metric lies, or APIs used without understanding failure modes. This topic is foundational for later LLM/RAG/agent work.
...
**Scenario:** Apply **Question Answering** on a small real dataset or API workload.
...
**Q: Explain question answering to a senior engineer in two minutes.**
