...
description: "Inject order — sinusoids, learned positions, RoPE, ALiBi."
...
> Inject order — sinusoids, learned positions, RoPE, ALiBi.
...
This lesson belongs to **Attention Modern Nlp** in the **Natural Language Processing** handbook. Goal: understand **Positional Encoding** well enough to implement, measure, and explain it in a design review.
...
**Positional Encoding** — Inject order — sinusoids, learned positions, RoPE, ALiBi.
