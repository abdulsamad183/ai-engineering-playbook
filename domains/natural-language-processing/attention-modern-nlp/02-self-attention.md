...
description: "Every token attends to every token in the same sequence."
...
> Every token attends to every token in the same sequence.
...
This lesson belongs to **Attention Modern Nlp** in the **Natural Language Processing** handbook. Goal: understand **Self-Attention** well enough to implement, measure, and explain it in a design review.
