...
This lesson belongs to **Text Processing** in the **Natural Language Processing** handbook. Goal: understand **Tokenization** well enough to implement, measure, and explain it in a design review.
...
**Tokenization** — Split text into model units — words, subwords, or characters.
