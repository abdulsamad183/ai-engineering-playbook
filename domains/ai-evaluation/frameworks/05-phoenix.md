...
> Arize Phoenix evaluation overview — observability, embeddings, drift, ideal use cases.
...
Part of **Frameworks** in the **LLM Evaluation** handbook. Treat **Phoenix Evaluation** as an implementable engineering topic.
...
**Phoenix Evaluation** — Arize Phoenix evaluation overview — observability, embeddings, drift, ideal use cases.
...
**Scenario:** Apply **Phoenix Evaluation** to a production-shaped slice of traffic.
...
**Q: How do you explain phoenix evaluation in a system design interview?**
