...
tags: [surface-areas, ai-evaluation]
status: published
created: 2026-08-11
updated: 2026-08-12
version: "2.0"
...
> RAG metrics — retrieval, context, faithfulness, RAGAS, ARES, DeepEval, evaluation workflows.
...
Part of **Surface Areas** in the **LLM Evaluation** handbook. Treat **RAG System Evaluation** as an implementable engineering topic.
...
**RAG System Evaluation** — RAG metrics — retrieval, context, faithfulness, RAGAS, ARES, DeepEval, evaluation workflows.
...
**Scenario:** Apply **RAG System Evaluation** to a production-shaped slice of traffic.
...
**Q: How do you explain rag system evaluation in a system design interview?**
