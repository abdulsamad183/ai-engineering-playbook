...
> E2E latency, TTFT, streaming, retrieval, tool, agent latency, P95/P99 budgets.
...
Part of **Metrics** in the **LLM Evaluation** handbook. Treat **Latency Evaluation** as an implementable engineering topic.
...
**Latency Evaluation** — E2E latency, TTFT, streaming, retrieval, tool, agent latency, P95/P99 budgets.
...
**Scenario:** Apply **Latency Evaluation** to a production-shaped slice of traffic.
...
**Q: How do you explain latency evaluation in a system design interview?**
