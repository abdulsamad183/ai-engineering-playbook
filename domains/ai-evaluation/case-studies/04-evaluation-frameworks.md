...
> RAGAS, DeepEval, LangSmith, Phoenix, OpenAI Evals — comparison and selection guide.
...
Part of **Case Studies** in the **LLM Evaluation** handbook. Treat **Evaluation Frameworks** as an implementable engineering topic.
...
**Evaluation Frameworks** — RAGAS, DeepEval, LangSmith, Phoenix, OpenAI Evals — comparison and selection guide.
...
**Scenario:** Apply **Evaluation Frameworks** to a production-shaped slice of traffic.
...
**Q: How do you explain evaluation frameworks in a system design interview?**
