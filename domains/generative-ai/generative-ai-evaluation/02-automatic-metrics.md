...
description: "**Automatic Metrics** is a core topic in Generative AI engineering: understanding how automatic metrics works, when to use it, and how to ship it safely with me"
...
This lesson is part of the **Generative Ai Evaluation** section in the Generative AI handbook. It treats **Automatic Metrics** as an engineering topic: definitions, system shape, code you can adapt, and production constraints (quality, latency, cost, safety).
...
**Automatic Metrics** is a core topic in Generative AI engineering: understanding how automatic metrics works, when to use it, and how to ship it safely with measurable quality.

---

## Why It Matters

Teams that skip automatic metrics ship demos that fail on quality, cost, latency, or safety under real traffic.
...
|----------|------------------|
| Product feature | Ship automatic metrics as a user-facing capability |
...
1. Define success metrics for automatic metrics before tuning models.
...
At a high level, automatic metrics sits in the GenAI loop: condition → sample → filter → measure.
...
**Scenario:** You need automatic metrics in a production feature with a clear success bar.
