---
title: "Likelihood-Based Models"
description: "Likelihood-based models train by maximizing (or lower-bounding) log p(x), including autoregressive models, flows, and many VAEs."
...
> Likelihood-based models train by maximizing (or lower-bounding) log p(x), including autoregressive models, flows, and many VAEs.
...
This lesson is part of the **Generative Models** section in the Generative AI handbook. It treats **Likelihood-Based Models** as an engineering topic: definitions, system shape, code you can adapt, and production constraints (quality, latency, cost, safety).
...
**Likelihood-Based Models** — Likelihood-based models train by maximizing (or lower-bounding) log p(x), including autoregressive models, flows, and many VAEs.

---

## Why It Matters

They offer principled density estimates useful for compression, anomaly, and stable training.
...
|----------|------------------|
| Product feature | Ship likelihood-based models as a user-facing capability |
...
1. Exact vs approximate likelihood.
2. AR models factorize tokens/pixels.
3. Flows invertible maps with tractable Jacobian.

---

## How It Works

At a high level, likelihood-based models sits in the GenAI loop: condition → sample → filter → measure.
...
**Scenario:** You need likelihood-based models in a production feature with a clear success bar.
