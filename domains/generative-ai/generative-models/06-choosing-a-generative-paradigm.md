---
title: "Choosing a Generative Paradigm"
description: "A decision framework for picking AR/LLM, GAN, VAE, or diffusion based on modality, latency, controllability, and team skills."
domain: generative-ai
tags: [generative-models, generative-ai]
status: published
created: 2026-08-11
updated: 2026-08-12
version: "2.0"
...
# Choosing a Generative Paradigm

> A decision framework for picking AR/LLM, GAN, VAE, or diffusion based on modality, latency, controllability, and team skills.
...
This lesson is part of the **Generative Models** section in the Generative AI handbook. It treats **Choosing a Generative Paradigm** as an engineering topic: definitions, system shape, code you can adapt, and production constraints (quality, latency, cost, safety).
...
**Choosing a Generative Paradigm** — A decision framework for picking AR/LLM, GAN, VAE, or diffusion based on modality, latency, controllability, and team skills.

---

## Why It Matters

Wrong paradigm locks you into painful infra and eval.
...
|----------|------------------|
| Product feature | Ship choosing a generative paradigm as a user-facing capability |
...
1. Text → AR/LLM default.
2. Photoreal images → latent diffusion default.
3. Ultra-low latency faces → optimized GAN/distilled diffusion.

---

## How It Works

At a high level, choosing a generative paradigm sits in the GenAI loop: condition → sample → filter → measure.

```mermaid
flowchart TB
  Need{Need}
  Need -->|text| AR
  Need -->|image quality| Diff
  Need -->|tiny latency| GAN
  Need -->|latents/repr| VAE
```
...
**Scenario:** You need choosing a generative paradigm in a production feature with a clear success bar.
