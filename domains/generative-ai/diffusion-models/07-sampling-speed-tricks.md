---
title: "Sampling Speed Tricks"
description: "Speed tricks include fewer steps, distilled students, better solvers (DPM++), TensorRT, and caching."
...
> Speed tricks include fewer steps, distilled students, better solvers (DPM++), TensorRT, and caching.
...
This lesson is part of the **Diffusion Models** section in the Generative AI handbook. It treats **Sampling Speed Tricks** as an engineering topic: definitions, system shape, code you can adapt, and production constraints (quality, latency, cost, safety).
...
**Sampling Speed Tricks** — Speed tricks include fewer steps, distilled students, better solvers (DPM++), TensorRT, and caching.

---

## Why It Matters

User-facing image apps live or die on time-to-image.
...
|----------|------------------|
| Product feature | Ship sampling speed tricks as a user-facing capability |
...
3. Batch and compile graphs.

---

## How It Works

At a high level, sampling speed tricks sits in the GenAI loop: condition → sample → filter → measure.
...
**Scenario:** You need sampling speed tricks in a production feature with a clear success bar.
