---
title: "VAE vs GAN vs Diffusion"
description: "VAEs, GANs, and diffusion models trade sample sharpness, diversity, training stability, and likelihood differently."
...
> VAEs, GANs, and diffusion models trade sample sharpness, diversity, training stability, and likelihood differently.
...
This lesson is part of the **Vaes** section in the Generative AI handbook. It treats **VAE vs GAN vs Diffusion** as an engineering topic: definitions, system shape, code you can adapt, and production constraints (quality, latency, cost, safety).
...
**VAE vs GAN vs Diffusion** — VAEs, GANs, and diffusion models trade sample sharpness, diversity, training stability, and likelihood differently.

---

## Why It Matters

Teams must pick stacks intentionally for product constraints.
...
|----------|------------------|
| Product feature | Ship vae vs gan vs diffusion as a user-facing capability |
...
At a high level, vae vs gan vs diffusion sits in the GenAI loop: condition → sample → filter → measure.

```mermaid
flowchart TB
  Compare[Compare] --> VAE
  Compare --> GAN
  Compare --> Diff[Diffusion]
```
...
**Scenario:** You need vae vs gan vs diffusion in a production feature with a clear success bar.
