---
title: "β-VAE & Disentangling"
description: "β-VAE upweights the KL term to encourage disentangled latent factors at the cost of reconstruction fidelity."
...
> β-VAE upweights the KL term to encourage disentangled latent factors at the cost of reconstruction fidelity.
...
This lesson is part of the **Vaes** section in the Generative AI handbook. It treats **β-VAE & Disentangling** as an engineering topic: definitions, system shape, code you can adapt, and production constraints (quality, latency, cost, safety).
...
**β-VAE & Disentangling** — β-VAE upweights the KL term to encourage disentangled latent factors at the cost of reconstruction fidelity.

---

## Why It Matters

Disentangling helps controllable generation and interpretability research.
...
|----------|------------------|
| Product feature | Ship β-vae & disentangling as a user-facing capability |
...
1. β > 1 encourages independence.
2. Tradeoff with fidelity.
3. Evaluate with disentanglement metrics carefully.

---

## How It Works

At a high level, β-vae & disentangling sits in the GenAI loop: condition → sample → filter → measure.
...
**Scenario:** You need β-vae & disentangling in a production feature with a clear success bar.
