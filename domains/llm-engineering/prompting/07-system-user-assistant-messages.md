...
description: "Chat templates — roles that modern APIs expect."
domain: llm-engineering
tags: [prompting, llm-engineering]
status: published
created: 2026-08-11
updated: 2026-08-12
version: "2.0"
...
> Chat templates — roles that modern APIs expect.
...
This lesson belongs to **Prompting** in the **Large Language Models** handbook. Goal: understand **System/User/Assistant Messages** well enough to implement, measure, and explain it in a design review.
...
**System/User/Assistant Messages** — Chat templates — roles that modern APIs expect.
...
Skipping system/user/assistant messages creates fragile systems: wrong preprocessing, silent metric lies, or APIs used without understanding failure modes. This topic is foundational for later LLM/RAG/agent work.
...
**Scenario:** Apply **System/User/Assistant Messages** on a small real dataset or API workload.
...
**Q: Explain system/user/assistant messages to a senior engineer in two minutes.**
