...
description: "Assign a persona/expertise to shape tone and priorities."
...
> Assign a persona/expertise to shape tone and priorities.
...
This lesson belongs to **Prompting** in the **Large Language Models** handbook. Goal: understand **Role Prompting** well enough to implement, measure, and explain it in a design review.
...
**Role Prompting** — Assign a persona/expertise to shape tone and priorities.
...
Skipping role prompting creates fragile systems: wrong preprocessing, silent metric lies, or APIs used without understanding failure modes. This topic is foundational for later LLM/RAG/agent work.
...
**Scenario:** Apply **Role Prompting** on a small real dataset or API workload.
...
**Q: Explain role prompting to a senior engineer in two minutes.**
