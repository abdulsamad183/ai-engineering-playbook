---
title: "Tool-Using LLMs"
description: "Function calling — calculators, browsers, APIs as skills."
...
> Function calling — calculators, browsers, APIs as skills.
...
This lesson belongs to **Advanced Llm Concepts** in the **Large Language Models** handbook. Goal: understand **Tool-Using LLMs** well enough to implement, measure, and explain it in a design review.
...
**Tool-Using LLMs** — Function calling — calculators, browsers, APIs as skills.
...
Skipping tool-using llms creates fragile systems: wrong preprocessing, silent metric lies, or APIs used without understanding failure modes. This topic is foundational for later LLM/RAG/agent work.
...
**Scenario:** Apply **Tool-Using LLMs** on a small real dataset or API workload.
...
**Q: Explain tool-using llms to a senior engineer in two minutes.**
