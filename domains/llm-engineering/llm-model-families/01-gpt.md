---
title: "GPT"
description: "Decoder-only lineage that popularized generative LLMs."
...
> Decoder-only lineage that popularized generative LLMs.
...
This lesson belongs to **Llm Model Families** in the **Large Language Models** handbook. Goal: understand **GPT** well enough to implement, measure, and explain it in a design review.
...
**GPT** — Decoder-only lineage that popularized generative LLMs.
...
Skipping gpt creates fragile systems: wrong preprocessing, silent metric lies, or APIs used without understanding failure modes. This topic is foundational for later LLM/RAG/agent work.
...
**Scenario:** Apply **GPT** on a small real dataset or API workload.
...
**Q: Explain gpt to a senior engineer in two minutes.**
