---
title: "Guardrails"
description: "Runtime checks — input/output filters and tool allowlists."
...
> Runtime checks — input/output filters and tool allowlists.
...
This lesson belongs to **Llm Safety** in the **Large Language Models** handbook. Goal: understand **Guardrails** well enough to implement, measure, and explain it in a design review.
...
**Guardrails** — Runtime checks — input/output filters and tool allowlists.
...
Skipping guardrails creates fragile systems: wrong preprocessing, silent metric lies, or APIs used without understanding failure modes. This topic is foundational for later LLM/RAG/agent work.
...
**Scenario:** Apply **Guardrails** on a small real dataset or API workload.
...
**Q: Explain guardrails to a senior engineer in two minutes.**
