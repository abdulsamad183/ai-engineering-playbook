---
title: "Hallucination"
description: "Fluent but false — the default risk of generative LMs."
...
> Fluent but false — the default risk of generative LMs.
...
This lesson belongs to **Llm Safety** in the **Large Language Models** handbook. Goal: understand **Hallucination** well enough to implement, measure, and explain it in a design review.
...
**Hallucination** — Fluent but false — the default risk of generative LMs.
...
Skipping hallucination creates fragile systems: wrong preprocessing, silent metric lies, or APIs used without understanding failure modes. This topic is foundational for later LLM/RAG/agent work.
...
**Scenario:** Apply **Hallucination** on a small real dataset or API workload.
...
**Q: Explain hallucination to a senior engineer in two minutes.**
