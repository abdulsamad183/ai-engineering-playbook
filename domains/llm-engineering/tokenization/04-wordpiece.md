---
title: "WordPiece"
description: "BERT-style subwords scored by likelihood gains."
...
> BERT-style subwords scored by likelihood gains.
...
This lesson belongs to **Tokenization** in the **Large Language Models** handbook. Goal: understand **WordPiece** well enough to implement, measure, and explain it in a design review.
...
**WordPiece** — BERT-style subwords scored by likelihood gains.
...
Skipping wordpiece creates fragile systems: wrong preprocessing, silent metric lies, or APIs used without understanding failure modes. This topic is foundational for later LLM/RAG/agent work.
...
**Scenario:** Apply **WordPiece** on a small real dataset or API workload.
...
**Q: Explain wordpiece to a senior engineer in two minutes.**
