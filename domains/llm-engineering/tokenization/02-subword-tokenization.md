...
description: "Between words and characters — handles rare words better."
domain: llm-engineering
tags: [tokenization, llm-engineering]
status: published
created: 2026-08-11
updated: 2026-08-12
version: "2.0"
...
> Between words and characters — handles rare words better.
...
This lesson belongs to **Tokenization** in the **Large Language Models** handbook. Goal: understand **Subword Tokenization** well enough to implement, measure, and explain it in a design review.
...
**Subword Tokenization** — Between words and characters — handles rare words better.
...
Skipping subword tokenization creates fragile systems: wrong preprocessing, silent metric lies, or APIs used without understanding failure modes. This topic is foundational for later LLM/RAG/agent work.
...
**Scenario:** Apply **Subword Tokenization** on a small real dataset or API workload.
...
**Q: Explain subword tokenization to a senior engineer in two minutes.**
