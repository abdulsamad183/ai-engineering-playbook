...
description: "BOS/EOS/PAD/UNK and chat markers — control structure."
...
> BOS/EOS/PAD/UNK and chat markers — control structure.
...
This lesson belongs to **Tokenization** in the **Large Language Models** handbook. Goal: understand **Special Tokens** well enough to implement, measure, and explain it in a design review.
...
**Special Tokens** — BOS/EOS/PAD/UNK and chat markers — control structure.
...
Skipping special tokens creates fragile systems: wrong preprocessing, silent metric lies, or APIs used without understanding failure modes. This topic is foundational for later LLM/RAG/agent work.
...
**Scenario:** Apply **Special Tokens** on a small real dataset or API workload.
...
**Q: Explain special tokens to a senior engineer in two minutes.**
