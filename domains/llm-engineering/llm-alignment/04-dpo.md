---
title: "DPO"
description: "Direct Preference Optimization — align without an explicit RL loop."
...
> Direct Preference Optimization — align without an explicit RL loop.
...
This lesson belongs to **Llm Alignment** in the **Large Language Models** handbook. Goal: understand **DPO** well enough to implement, measure, and explain it in a design review.
...
**DPO** — Direct Preference Optimization — align without an explicit RL loop.
...
Skipping dpo creates fragile systems: wrong preprocessing, silent metric lies, or APIs used without understanding failure modes. This topic is foundational for later LLM/RAG/agent work.
...
**Scenario:** Apply **DPO** on a small real dataset or API workload.
...
**Q: Explain dpo to a senior engineer in two minutes.**
