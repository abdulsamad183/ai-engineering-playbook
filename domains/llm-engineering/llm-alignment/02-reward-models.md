---
title: "Reward Models"
description: "Models that score which response humans would prefer."
...
> Models that score which response humans would prefer.
...
This lesson belongs to **Llm Alignment** in the **Large Language Models** handbook. Goal: understand **Reward Models** well enough to implement, measure, and explain it in a design review.
...
**Reward Models** — Models that score which response humans would prefer.
...
Skipping reward models creates fragile systems: wrong preprocessing, silent metric lies, or APIs used without understanding failure modes. This topic is foundational for later LLM/RAG/agent work.
...
**Scenario:** Apply **Reward Models** on a small real dataset or API workload.
...
**Q: Explain reward models to a senior engineer in two minutes.**
