...
description: "Down-weight already-used tokens to reduce loops."
...
> Down-weight already-used tokens to reduce loops.
...
This lesson belongs to **Llm Inference** in the **Large Language Models** handbook. Goal: understand **Repetition Penalty** well enough to implement, measure, and explain it in a design review.
...
**Repetition Penalty** — Down-weight already-used tokens to reduce loops.
...
Skipping repetition penalty creates fragile systems: wrong preprocessing, silent metric lies, or APIs used without understanding failure modes. This topic is foundational for later LLM/RAG/agent work.
...
**Scenario:** Apply **Repetition Penalty** on a small real dataset or API workload.
...
**Q: Explain repetition penalty to a senior engineer in two minutes.**
