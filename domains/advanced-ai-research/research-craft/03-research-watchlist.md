...
description: "Research Watchlist — engineering-focused research guidance."
domain: advanced-ai-research
tags: [research-craft, 03-research-watchlist]
status: published
created: 2026-08-12
updated: 2026-08-12
version: "1.0"
...
> Research Watchlist — engineering-focused research guidance.
...
This lesson covers **Research Watchlist** inside the `research-craft` section of the `advanced-ai-research` handbook. Treat it as production engineering guidance: clear definitions, when to apply the idea, system shape, and code you can adapt.

---

## Definition

**Research Watchlist** — Research Watchlist — engineering-focused research guidance.
