...
> MCP tools — schemas, registry, discovery, permissions, composition, streaming, errors, retries.
...
Part of **Primitives** in the **MCP** handbook. Treat **MCP Tools** as an implementable engineering topic.
...
**MCP Tools** — MCP tools — schemas, registry, discovery, permissions, composition, streaming, errors, retries.
...
**Scenario:** Apply **MCP Tools** to a production-shaped slice of traffic.
...
**Q: How do you explain mcp tools in a system design interview?**
