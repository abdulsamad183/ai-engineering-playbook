...
> MCP resources — static/dynamic, URI design, metadata, discovery, pagination, access control, caching.
...
Part of **Primitives** in the **MCP** handbook. Treat **MCP Resources** as an implementable engineering topic.
...
**MCP Resources** — MCP resources — static/dynamic, URI design, metadata, discovery, pagination, access control, caching.
...
**Scenario:** Apply **MCP Resources** to a production-shaped slice of traffic.
...
**Q: How do you explain mcp resources in a system design interview?**
