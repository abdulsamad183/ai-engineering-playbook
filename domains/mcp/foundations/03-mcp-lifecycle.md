...
> MCP session lifecycle — discovery, capability negotiation, initialization, requests, streaming, termination.
...
Part of **Foundations** in the **MCP** handbook. Treat **MCP Lifecycle** as an implementable engineering topic.
...
**MCP Lifecycle** — MCP session lifecycle — discovery, capability negotiation, initialization, requests, streaming, termination.
...
**Scenario:** Apply **MCP Lifecycle** to a production-shaped slice of traffic.
...
**Q: How do you explain mcp lifecycle in a system design interview?**
