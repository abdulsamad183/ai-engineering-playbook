...
> MCP clients, servers, resources, prompts, tools, messages, sessions, capabilities, notifications.
...
Part of **Foundations** in the **MCP** handbook. Treat **MCP Core Concepts** as an implementable engineering topic.
...
**MCP Core Concepts** — MCP clients, servers, resources, prompts, tools, messages, sessions, capabilities, notifications.
...
**Scenario:** Apply **MCP Core Concepts** to a production-shaped slice of traffic.
...
**Q: How do you explain mcp core concepts in a system design interview?**
