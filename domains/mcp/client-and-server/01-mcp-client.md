...
> MCP client architecture — connection, discovery, capability negotiation, tool invocation, streaming, retries.
...
Part of **Client And Server** in the **MCP** handbook. Treat **MCP Client** as an implementable engineering topic.
...
**MCP Client** — MCP client architecture — connection, discovery, capability negotiation, tool invocation, streaming, retries.
...
**Scenario:** Apply **MCP Client** to a production-shaped slice of traffic.
...
**Q: How do you explain mcp client in a system design interview?**
