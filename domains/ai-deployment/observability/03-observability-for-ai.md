...
> OpenTelemetry, LangFuse, Phoenix — prompt, agent, RAG tracing.
...
Part of **Observability** in the **AI Deployment & Infrastructure** handbook. Treat **Observability for AI** as an implementable engineering topic.
...
**Observability for AI** — OpenTelemetry, LangFuse, Phoenix — prompt, agent, RAG tracing.
...
**Scenario:** Apply **Observability for AI** to a production-shaped slice of traffic.
...
**Q: How do you explain observability for ai in a system design interview?**
