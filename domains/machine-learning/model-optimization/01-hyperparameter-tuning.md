...
This lesson is part of the **Model Optimization** track in the **Machine Learning** handbook. Treat **Hyperparameter Tuning** as something you can implement, measure, and ship — not only define.
...
**Hyperparameter Tuning** — Search model knobs on validation / CV — never on the final test set.
