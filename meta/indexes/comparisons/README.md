...
> Technology and approach comparison matrices for informed decision-making.
...
| [AI System Design](../../domains/ai-system-design/ai-system-design-comparison-guides.md) | RAG vs fine-tune, monolith vs microservices | Published |
| [Production AI](../../domains/ai-deployment/production-ai-comparison-guides.md) | Deploy, observability, caching | Published |
...
| [Prompt Engineering Strategies](../../domains/prompt-engineering/production-and-safety/04-prompt-comparison-guides.md) | Zero-shot vs few-shot, XML vs JSON, CoT vs ReAct | Published |
| [Vector Databases](../../domains/rag/rag-comparison-guides.md#vector-databases) | pgvector, Pinecone, Weaviate, Qdrant, Chroma, Milvus, FAISS | Published |
...
| [LLM Providers](llm-providers.md) | OpenAI, Anthropic, Google, open-source | Planned |
| [Deployment Platforms](deployment-platforms.md) | Cloud options for AI applications | Planned |

---

## Comparison Template

Each comparison index follows this structure:
...
- Links to detailed technology docs
```
